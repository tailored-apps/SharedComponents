...
{
    Task<HotPayResponse?> InitPaymentAsync(PaymentRequest request, string paymentId);
...
public class HotPayServiceCaller : IHotPayServiceCaller
{
    ...
    public async Task<HotPayResponse?> InitPaymentAsync(PaymentRequest request, string paymentId)
    {
        ...
        return JsonSerializer.Deserialize<HotPayResponse>(responseJson);
    }
...
public class HotPayProvider : IPaymentProvider
{
    ...
    public async Task<PaymentResponse> RequestPayment(PaymentRequest request)
    {
        ...
        var result    = await caller.InitPaymentAsync(request, paymentId);

        return new PaymentResponse
        {
            PaymentUniqueId = result?.PaymentId ?? paymentId,
...
public class HotPayConfigureOptions : IConfigureOptions<HotPayServiceOptions>
{
    ...
    public void Configure(HotPayServiceOptions options)
    {
        ...
        options.PaymentUrl = s.PaymentUrl;
